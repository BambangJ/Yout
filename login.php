...
<head>
    ...
    <title>Login Kasir YesMie! |</title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
        <img class="mb-4" src="assets/images/Kantin.png" alt="" width="300" height="150">
        ...
        <p class="mt-3 mb-3 text-dark"> Belum Punya Akun? <a href="registrasi.php" class="text-primary">
                Registrasi</a></p>
    </form>
