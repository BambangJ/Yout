...
<div class="row">
    ...
    <div class="col-6 col-sm-6 col-md-3 col-lg-3 m-pr-1 m-mb-1">
        <div class="box-laporan" style="background-color: #c0c0c0;">
            <p class="small mb-0 text-dark">Terjual</p>
            <h5 class="mb-0 text-dark"><?php echo ribuan($i1['totqty']); ?></h5>
        </div>
    </div>

    <div class="col-6 col-sm-6 col-md-3 col-lg-3 m-pl-1 m-mb-1">
        <div class="box-laporan" style="background-color: #c0c0c0;">
            <p class="small mb-0 text-dark">Pendapatan</p>
            <h5 class="mb-0 text-dark">Rp.<?php echo ribuan($i3['totdpt1']); ?></h5>
        </div>
    </div>

    <div class="col-6 col-sm-6 col-md-3 col-lg-3 m-pr-1">
        <div class="box-laporan" style="background-color: #c0c0c0;">
            <p class="small mb-0 text-dark">Penjualan</p>
            <h5 class="mb-0 text-dark">Rp.<?php echo ribuan($i2['totdpt']); ?></h5>
        </div>
    </div>

    <div class="col-6 col-sm-6 col-md-3 col-lg-3 m-pl-1">
        <div class="box-laporan" style="background-color: #c0c0c0;">
            <p class="small mb-0 text-dark">Total</p>
            <h5 class="mb-0 text-dark">Rp.<?php echo ribuan($i4['isub']); ?></h5>
        </div>
    </div>
