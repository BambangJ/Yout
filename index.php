...
<?php $dataselect = mysqli_query($conn, "SELECT * FROM menu");
$jsArray = "var nama_menu = new Array();";
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-md-4 col-lg-3 mb-3">
            ...
            <div class="position-relative">
                <input type="text" name="Ckdmenu" class="form-control form-control-sm" list="datalist1"
                    onchange="changeValue(this.value)" required autofocus>
                <datalist id="datalist1">
                    <?php if(mysqli_num_rows($dataselect)) {?>
                    <?php while($row_brg= mysqli_fetch_array($dataselect)) {?>
                    <option value="<?php echo $row_brg["kode_menu"]?>"> <?php echo $row_brg["kode_menu"]?>
                        <?php $jsArray .= "nama_menu['" . $row_brg['kode_menu'] . "'] = {nama_menu:'" . addslashes($row_brg['nama_menu']) . "'};";
            $jsArray1 .= "harga_jual['" . $row_brg['kode_menu'] . "'] = {harga_jual:'" . addslashes($row_brg['harga_jual']) . "'};";
            $jsArray2 .= "harga_modal['" . $row_brg['kode_menu'] . "'] = {harga_modal:'" . addslashes($row_brg['harga_modal']) . "'};"; } ?>
                        <?php } ?>
                </datalist>
        ...
        <div class="col-sm-4 col-md-4 col-lg-3 mb-3">
            ...
            <input type="text" name="Cnmenu" id="nama_menu" class="form-control form-control-sm bg-light" readonly>
        ...
        <div class="col-4 col-sm-4 col-md-4 col-lg-1 mb-3">
            ...
            <input type="number" name="Cqty" id="Iqty" onchange="InputSub()" placeholder="0"
                class="form-control form-control-sm" required>
        </div>
        <div class="col-sm-8 col-md-8 col-lg-3 mb-3">
            <label class="small text-muted mb-1">Subtotal</label>
            <div class="input-group">
                <input type="number" name="Csubs" placeholder="0" id="Isubtotal" onchange="InputSub()"
...
{
    $Input1 = htmlspecialchars($_POST['Ckdmenu']);
    $Input2 = htmlspecialchars($_POST['Cnmenu']);
    ...
    if($liat>0){
      $cekbrg = mysqli_query($conn,"SELECT * FROM cart WHERE kode_menu='$Input1' and invoice='$inv_c'");
      ...
      if($liatlg>0){
        ...
        $updateaja = mysqli_query($conn,"UPDATE cart SET qty='$baru', subtotal='$baru1' WHERE invoice='$inv_c' and kode_menu='$Input1'");
        if($updateaja){
      ...
      $tambahdata = mysqli_query($conn,"INSERT INTO cart (invoice,kode_menu,nama_menu,harga,harga_modal,qty,subtotal)
  ...
  $oi = $huruf . date("jnyGi") . sprintf("%02s", $urutan);
    ...
    if($bikincart){
      $tambahuser = mysqli_query($conn,"INSERT INTO cart (invoice,kode_menu,nama_menu,harga,harga_modal,qty,subtotal)
...
<div class="bg-light p-3" style="border-radius:0.25rem;">
    <div class="row gy-3 align-items-center row-home">
        ...
        <div class="col-md-8 col-lg-6 mb-2">
            <form method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-8 col-sm-8 col-md-8 col-lg-9 mb-2">
                        <input type="text" class="form-control form-control-sm bg-light" id="kembalian" placeholder="0"
                            readonly>
       ...
       if($x1>0){
        ?>
                        <a href="?hapusAll=<?php echo $noinv ?>"
...
if(isset($_POST['import']))
{
    ...
    $UpdCart = mysqli_query($conn,"UPDATE inv SET
     ...
     $UpdLap = mysqli_query($conn, "INSERT INTO laporan (invoice,kode_menu,nama_menu,harga,harga_modal,qty,subtotal)
     SELECT invoice,kode_menu,nama_menu,harga,harga_modal,qty,subtotal FROM cart") or die (mysqli_connect_error());
...
<div class="modal fade" id="Exit" tabindex="-1" role="dialog">
    ...
    function changeValue(kode_menu) {
        document.getElementById("nama_menu").value = nama_menu[kode_menu].nama_menu;
        document.getElementById("harga_jual").value = harga_jual[kode_menu].harga_jual;
        document.getElementById("harga_modal").value = harga_modal[kode_menu].harga_modal;
    };
