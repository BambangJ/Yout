        ...
        <div class="media align-items-end profile-header">
            <form method="POST" action="proses-logo.php" enctype="multipart/form-data">
                <div class="profile mr-3">
                    <label for="logo"><img src="assets/images/<?php echo $logo ?>" alt="logo"
                            class="img-cover-profile rounded mb-2 img-thumbnail"></label>
                ...
                <form method="post">
                    <div class="row">
                        <div class="col-sm-6 col-md-6 mb-2">
                            ...
                            <input name="nama_toko" type="text" class="form-control" value="<?php echo $toko ?>"
                                id="namatoko" placeholder="nama toko" required>
                        </div>
                        <div class="col-sm-6 col-md-6 mb-2">
                        ...
                        <div class="col-sm-6 col-md-6 mb-2">
                            ...
                            <input name="telepon" type="number" class="form-control" value="<?php echo $telepon ?>"
                                id="telepon" placeholder="0821xxx" required>
                        </div>
                        <div class="col-sm-6 col-md-6 mb-2">
                            ...
                            <div style="display:none;width: 100%;" class="cuss" id="Tambah1">
                                <div class="tengah-tengah px-3">
                                    <div class="input-group">
                                        <input name="password" type="password" placeholder="Verifikasi Password"
                                            class="form-control mr-2" required>
                                        <div class="input-group-append">
                                            <button type="submit" name="SimpanEdit"
                                                class="btn btn-primary px-3">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="PagePassword" class="tab-pane fade"><br>
                <form method="POST">
                    <div class="form-group row">
                        <label class="col-sm-4 col-md-4 col-lg-3 col-form-label">Password Lama<span
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-md-4 col-lg-3 col-form-label">Password Baru<span
                                class="text-danger">*</span></label>
                        <div class="col-sm-8 col-md-7 col-lg-4">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-md-4 col-lg-3 col-form-label">Konfirmasi Password<span
                                class="text-danger">*</span></label>
                        <div class="col-sm-8 col-md-7 col-lg-4">
